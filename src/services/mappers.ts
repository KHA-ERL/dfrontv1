...
export function mapProduct(raw: any) {
  ...
  return {
    ...
    conditionRating: raw.condition_rating ?? raw.conditionRating ?? null,
    location_state: raw.location_state ?? raw.locationState ?? '',
    locationState: raw.location_state ?? raw.locationState ?? '',
    ...
    outOfStock: raw.out_of_stock ?? raw.outOfStock ?? false,
